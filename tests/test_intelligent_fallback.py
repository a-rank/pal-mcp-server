...
class TestIntelligentFallback:
    ...
    def test_prefers_gemini_flash_when_openai_unavailable(self):
        ...
        fallback_model = ModelProviderRegistry.get_preferred_fallback_model()
        assert fallback_model in ["gemini-3.1-flash-lite-preview", "gemini-3-flash-preview", "gemini-2.5-flash"]
    ...
    def test_prefers_openai_when_both_available(self):
        ...
        fallback_model = ModelProviderRegistry.get_preferred_fallback_model()
        assert fallback_model in ["gemini-3.1-flash-lite-preview", "gemini-3-flash-preview", "gemini-2.5-flash"]  # Gemini has priority now (based on new PROVIDER_PRIORITY_ORDER)
    ...
    def test_fallback_when_no_keys_available(self):
        ...
        fallback_model = ModelProviderRegistry.get_preferred_fallback_model()
        assert fallback_model in ["gemini-3.1-flash-lite-preview", "gemini-3-flash-preview", "gemini-2.5-flash"]  # Default fallback
    ...
    def test_auto_mode_with_gemini_only(self):
        ...
        with (
            ...
            with patch("utils.model_context.ModelContext") as mock_context_class:
                ...
                call_arg = mock_context_class.call_args[0][0]
                assert call_arg in ["gemini-3.1-flash-lite-preview", "gemini-3-flash-preview", "gemini-2.5-flash"]
