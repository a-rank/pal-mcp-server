...
class TestAutoModeProviderSelection:
    ...
    def test_gemini_only_fallback_selection(self):
        ...
        try:
            ...
            assert fast_response in ["gemini-3.1-flash-lite-preview", "gemini-3-flash-preview", "gemini-2.5-flash", "flash"]
            assert balanced in ["gemini-3.1-flash-lite-preview", "gemini-3-flash-preview", "gemini-2.5-flash", "flash"]
    ...
    def test_both_gemini_and_openai_priority(self):
        ...
        try:
            ...
            assert fast_response in ["gemini-3.1-flash-lite-preview", "gemini-3-flash-preview", "gemini-2.5-flash"]
